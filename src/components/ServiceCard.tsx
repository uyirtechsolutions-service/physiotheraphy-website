...
export default function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <Link
      ...
      className="group relative flex aspect-square flex-col justify-end overflow-hidden rounded-xl border border-brand-200 bg-brand-900 transition-all duration-300 hover:border-brand-300 hover:shadow-lg"
    >
      <Image
        src={service.image}
        alt={service.title}
      ...
      <div className="relative p-4">
        ...
        <span className="mt-4 inline-flex items-center justify-center gap-1.5 rounded-md bg-brand-200 px-4 py-2.5 text-xs font-semibold text-brand-800 shadow-sm transition-colors duration-300 group-hover:bg-brand-50 group-hover:text-brand-700">
          Book Appointment
